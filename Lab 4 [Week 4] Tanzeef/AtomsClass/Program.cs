namespace AtomsClass
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Atom> deserializedAtoms = ReadJson("atoms.json");

            foreach (Atom atom in deserializedAtoms)
            {
        ...
        {
            string jsonString = JsonSerializer.Serialize(atoms);
